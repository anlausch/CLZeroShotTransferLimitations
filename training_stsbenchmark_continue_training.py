...
train_batch_size = 16
num_epochs = 4
model_save_path = '/home/anlausch/.cache/torch/sentence_transformers/training_stsbenchmark_continue_training-'+model_name+'-'+datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
sts_reader = STSDataReader('./finetune_data/stsbenchmark', normalize_scores=True)
