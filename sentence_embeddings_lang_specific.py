...
num_examples = 50
model_path_prefix = '/home/anlausch/.cache/torch/sentence_transformers/training_xnli_rand_'
model_path_suffix = "_" + str(num_examples) + '_continue_training-nli_bert-base-multilingual-cased-mean'

save_path = "/work/anlausch/DebunkMLBERT/data/ml_bert_xnli_crosslingual_rand_" + str(num_examples) + "_mean_token_embs"

wikimatrix_path = "/work/anlausch/DebunkMLBERT/data/Wikimatrix/filtered"
print("Loading Wikimatrix files")
#("tr", "zh"), ("sv", "zh"), ("ru", "zh"), ("ko", "zh"), ("ja", "zh"), ("it", "zh"), ("hi", "zh"), ("he", "zh"), ("fi", "zh"), ("en", "zh"), tODO: add this again
for comb in [
             ("ar", "zh"), ("eu", "tr"), ("eu", "sv"), ("eu", "ru"), ("eu", "ko"),
             ("eu", "ja"),
             ("eu", "it"), ("eu", "hi"), ("eu", "he"), ("eu", "fi"), ("en", "eu"), ("eu", "zh"),
             ("ar", "eu"), ]:

    model_path = model_path_prefix + comb[0] + "_" + comb[1] + model_path_suffix + "*"
