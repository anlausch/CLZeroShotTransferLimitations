        ...
        for learning_rate in 3e-5; do
            for num_training_epochs in 1.0; do
                ...
                for num_examples in 10 50 100 200 500 1000; do
                    ...
                    test_language_fake=en

                    model_path=./data/xlmr_xnli_${train_language_original}_${test_language_fake}_${learning_rate}_2.0
                    ...
                    for train_language in  "en" "fr" "es" "el" "bg" "ru" "tr" "ar" "vi" "th" "zh" "hi" "sw" "ur" "de"; do
                        ...
                        python run_xnli_xlmr.py \
                          ...
                          --seed ${iteration} \
                          --output_dir ./data/eval_xlmr_xnli_retrain_${num_examples}_${sampling_strategy}_${train_language}_${learning_rate}_${num_training_epochs}_${iteration} \
                          --save_steps -1
                    done;
                done;
            done;
